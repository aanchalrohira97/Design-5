...
class GFG {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "Parked at Floor: " + n.getFloor() + ", Slot: " + n.getSpot()
    );
    ...
    System.out.println(
      "Parked at Floor: " + n2.getFloor() + ", Slot: " + n2.getSpot()
    );
    ...
    System.out.println(
      "Parked at Floor: " + n1.getFloor() + ", Slot: " + n1.getSpot()
    );
  }
    ...
    public void addParkingSpot(int floor, int spot) {
      if (floor > maxFloors) {
        throw new IllegalArgumentException(
          "floor input greater than max allowed"
        );
      }

      if (spot > spotsPerFloor) {
        throw new IllegalArgumentException(
          "spots input greater than max allowed"
        );
      }
